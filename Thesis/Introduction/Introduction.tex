...
\\
\\
Shapes are detected on multiple levels-of-detail in the point cloud. A clustering algorithm takes shapes from different level-of-detail, based on a similarity heuristic, and creates a larger connected cluster of shapes. This cluster is used to present information on a larger scale to the user, rather than each shape separately. 
\\
\\ 
