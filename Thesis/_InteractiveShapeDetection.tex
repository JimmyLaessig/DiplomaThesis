...
\setdate{23}{08}{2017} % Set date with 3 arguments: {day}{month}{year}.
...
\input{Octree/Octree.tex}
\input{Shape_Detection/Shape_Detection.tex}
\input{Shape_Detection/Shape_Clustering.tex}
