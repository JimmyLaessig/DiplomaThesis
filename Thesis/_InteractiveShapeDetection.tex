...
\setdate{12}{10}{2017} % Set date with 3 arguments: {day}{month}{year}.
...
Point picking is improved as well by the use of a detected shape, such that only points that are approximated by this shape are pick-able. 
