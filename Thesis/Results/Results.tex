...
\begin{table}
	...
	\end{tabular}
\caption[Original shape detection performance measures for different datasets]{This table presents performance measures of the original shape detection for the different datasets. Each dataset is benchmarked using plane detection only (items with *), as well as detecting all types of primitive shapes. The results are averaged over five runs. } 
